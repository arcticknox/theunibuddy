...
function SignUp() {
    ...
    const signUpUserAPI = async () => {
        ...
        if (response) setValues({ hasRegistered: true });
    }
    ...
    return (
        <Container maxWidth="md" className='signup-container'>
            ...
            <div>
                <Button onClick={async () => {await signUpUserAPI()}} className='signup-button' variant="outlined">Sign Up</Button>
            </div>
            </div> : 
            <div>
                 <div>
                ...
                <p>You're almost there! We sent an email to the email provided.</p>
