...
function Login() {
    ...
    return (
        <Container maxWidth="md" className='login-container'>
            ...
            <div>
                <Button onClick={async () => { await loginUserAPI() }} className='login-button' variant="outlined">
                    Login
                </Button>
                <Link style={{ textDecoration: 'none' }} to='/signup'><Button className='signup-button' variant="outlined">Sign Up</Button></Link>
            </div>
